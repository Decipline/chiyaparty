...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Chiya Party — कप सँग गफ | Kathmandu's Coziest Chiya Garden" },
      { name: "description", content: "Sip hot chiya under fairy lights at Chiya Party — a bamboo-and-thatch garden cafe in Kathmandu serving momos, thukpa, pakoda & more. कप सँग गफ!" },
